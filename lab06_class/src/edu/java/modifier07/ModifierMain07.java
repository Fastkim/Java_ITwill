...
public class ModifierMain07 {
     ...
     public static void main(String[] args) {
        ...
        StaticTest.printVarialbes2();
        
        System.out.println();
        // 인스턴스 멤버(변수, 메서드)는 참조 변수를 이용해서 사용.
        StaticTest test01 = new StaticTest();
        System.out.println(test01.instanceVariable);
        System.out.println(test01.staticVariable);
        // static 변수를 참조 변수를 이용해서 사용할 수는 있지만, 권장하지 않는 방법.
        
        // static 변수는 클래스 이름으로 참조하는 것을 권장.

        test01.instanceVariable = 10;
        test01.printVariables();
