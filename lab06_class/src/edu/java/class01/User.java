...
//        this.userId = userId;
//        this.password = password;
        this(userId, password, 0); // constructor - 2를 호출.
    }
...
//        this(userId, null); // constructor - 3 호출
    ...
    // (2) 생성자: overloading된 다른 생성자를 호출 할 때
}
