...
public class VariableMain01 {
	...
	public static void main(String[] args) {
		...
		long salary = 10000000000L;  //100억이라는 정수를 만들기위해 뒤에 L을 붙였다.
		//자바는 기본적으로 int(4byte)숫자로 설정하기때문에 10억까지만 표현가능
		//자바는 기본적으로 실수를 만들때는 double(8byte)를 사용
		...
		double z = 123.0;
		double div = z / y; // 123.0 / 10 = result(int) (x)
