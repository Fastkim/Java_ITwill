...
public class AppMain06 {
    ...
    private void initialize() {
        ...
        JButton btnMsgDIg = new JButton("Message Dialog");
...
//                JOptionPane.showMessageDialog(frame, "안녕하세요.");
        ...
        btnMsgDIg.setFont(new Font("D2Coding", Font.PLAIN, 30));
        btnMsgDIg.setBounds(12, 10, 410, 102);
...
//                int result = JOptionPane.showConfirmDialog(frame, "삭제할까요?");
        ...
        btnConfirmDlg.setFont(new Font("D2Coding", Font.PLAIN, 30));
        btnConfirmDlg.setBounds(12, 122, 410, 102);
        ...
        btnOptionDlg.setFont(new Font("D2Coding", Font.PLAIN, 30));
        btnOptionDlg.setBounds(12, 234, 410, 102);
...
//                String input = JOptionPane.showInputDialog(frame, "이름");
        ...
        btnInputDlg.setFont(new Font("D2Coding", Font.PLAIN, 30));
        btnInputDlg.setBounds(12, 346, 410, 102);
        ...
        btnCustomDlg.setFont(new Font("D2Coding", Font.PLAIN, 30));
        btnCustomDlg.setBounds(12, 458, 410, 102);
        ...
        btnCustomFrame.setFont(new Font("D2Coding", Font.PLAIN, 30));
        btnCustomFrame.setBounds(12, 570, 410, 102);
