...
public class AppMain02 {
    ...
    private void initialize() {
        ...
        lblResult.setFont(new Font("D2Coding", Font.BOLD, 30));
        lblResult.setBounds(12, 10, 410, 80);
        frame.getContentPane().add(lblResult); // JLabel이 화면에 추가
        
        textInput = new JTextField();
        textInput.setFont(new Font("D2Coding", Font.BOLD, 30));
        textInput.setBounds(12, 119, 410, 73);
        ...
        btnInput.setFont(new Font("D2Coding", Font.BOLD, 30));
        btnInput.setBounds(12, 202, 410, 49);
